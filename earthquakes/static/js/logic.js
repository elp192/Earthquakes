...
data_1="https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson"
// Retrieve the major earthquake GeoJSON data >4.5 mag for the week.
d3.json(data_1).then(function(data) {
...
data_2="https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"
  
// Use d3.json to make a call to get our Tectonic Plate geoJSON data.
  d3.json(data_2).then(data => {
    L.geoJson(data, {
